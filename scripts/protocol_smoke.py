...
def main() -> int:
    ...
    try:
        ...
        required = {"search_stock", "get_realtime_quote", "get_financial_summary", "get_company_snapshot", "get_research_pack", "get_announcement_detail", "get_industry_peers", "get_peer_comparison", "get_index_snapshot", "get_sector_snapshot", "get_sector_components", "get_financial_events_pack", "get_dividend_events", "get_repurchase_events", "get_shareholder_change_events", "get_financing_events", "get_restricted_release_events"}
